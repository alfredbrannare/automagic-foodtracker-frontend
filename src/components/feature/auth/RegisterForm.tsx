import {Button, CardContent, Checkbox, ErrorInput, Input, Label} from "@/components/ui";
            ...
            <CardContent>
                <form className="grid gap-6" onSubmit={handleSubmit}>
                    ...
                    <div className="grid gap-3">
                        ...
                        <Input id="email" type="email" required={true} value={formData.email} onChange={(e) => setFormData({...formData, email: e.target.value})}/>
                    </div>
                    <div className="grid gap-3">
                    ...
                    <div className="flex flex-row items-center gap-4">
                        ...
                        <Label htmlFor="terms">I agree to the storage and use of my email address for account-related purposes.</Label>
                    </div>
